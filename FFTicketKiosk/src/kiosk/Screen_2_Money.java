...
public class Screen_2_Money extends JFrame {
...
//	//프레임 생성
//	JFrame Screen_2_Money = new JFrame();
	...
	Screen_2_Money(int n, int in, int out, Seat s, String t1, String t2, String t3, String t4){
		Seat a =s;
		...
		popCardL.setText("<HTML>현금을 투입하세요<br>"
				//					+"<br>"
									+ "결제가 완료됩니다");
